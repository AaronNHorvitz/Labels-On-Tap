...
| brand_mismatch_fail | GOV_WARNING_HEADER_CAPS, GOV_WARNING_EXACT_TEXT, ALCOHOL_ABV_PROHIBITED, MALT_NET_CONTENTS_16OZ_PINT, FORM_BRAND_MATCHES_LABEL, COUNTRY_OF_ORIGIN_MATCH | fail | synthetic_generation | Application brand intentionally does not appear in the label OCR text. |
| imported_missing_country_review | GOV_WARNING_HEADER_CAPS, GOV_WARNING_EXACT_TEXT, ALCOHOL_ABV_PROHIBITED, MALT_NET_CONTENTS_16OZ_PINT, FORM_BRAND_MATCHES_LABEL, COUNTRY_OF_ORIGIN_MATCH | needs_review | synthetic_generation | Imported application omits the expected country-of-origin field. |
| conflicting_country_origin_fail | GOV_WARNING_HEADER_CAPS, GOV_WARNING_EXACT_TEXT, ALCOHOL_ABV_PROHIBITED, MALT_NET_CONTENTS_16OZ_PINT, FORM_BRAND_MATCHES_LABEL, COUNTRY_OF_ORIGIN_MATCH | fail | synthetic_generation | Application expects France, but label OCR contains a conflicting Italy origin statement. |
| warning_missing_block_review | OCR_LOW_CONFIDENCE, GOV_WARNING_HEADER_BOLD_REVIEW, COUNTRY_OF_ORIGIN_MATCH | needs_review | synthetic_generation | Warning block omitted and fixture OCR confidence lowered to force human review. |
