...
def positive_pair(target: dict[str, Any]) -> dict[str, Any]:
    ...
    return {
        ...
        "target_expected_normalized": target["expected_normalized"],
        "candidate_text": target["expected"],
        "candidate_text_normalized": target["expected_normalized"],
...
def negative_pair(target: dict[str, Any], source: dict[str, Any], index: int) -> dict[str, Any]:
    ...
    return {
        ...
        "target_expected": target["expected"],
        "target_expected_normalized": target["expected_normalized"],
        "candidate_text": source["expected"],
        "candidate_text_normalized": source["expected_normalized"],
    ...
    *,
    ...
    return {
        ...
        "notes": [
            ...
            "Pair rows include target_expected and candidate_text so text-pair classifiers can learn support explicitly.",
