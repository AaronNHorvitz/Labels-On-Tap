...
def starter_criteria() -> list[dict[str, object]]:
    return [
        ...
        {
            "rule_id": "GOV_WARNING_HEADER_BOLD",
            "name": "Government warning heading boldness",
            "beverage_types": ["wine", "distilled_spirits", "malt_beverage"],
            ...
            "detection_method": "OpenCV stroke-width and ink-density heuristic using OCR bounding boxes.",
            "pass_condition": "Heading stroke/ink metrics clearly exceed body text metrics.",
            "fail_condition": "Heading is clearly not bold and image quality is sufficient.",
            "needs_review_condition": "Image quality or OCR boxes are insufficient for reliable font-weight estimation.",
            "implemented_status": "planned",
            "app_module": "app/rules/strict_warning.py",
