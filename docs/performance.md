...
## Current Model-Selection Statistics

The latest typography model-selection comparison is statistically controlled:
all base models and ensembles use the same `audit-v6` train/validation/test
...
| `pytest -q` in freshly rebuilt app container | 91 tests in 1.94 s |
